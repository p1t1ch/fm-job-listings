const config = {
  ...
  shortTitle: 'FM Job listings with filtering',
  // Project description. Used in SEO meta tag and by PWA
  description: 'My solution for Frontend Mentor "Job listings with filtering" challenge',
  ...
  baseUrl: 'https://p1t1ch-fm-job-listings.netlify.app',
